...
`,
    ...
    //         "201019867911" + "@c.us",
    //         `
    // لقد تلقيت هذا البريد لانك قمت بالتسجيل في موقع لتسكنوا
    // :من فضلك قم بالدخول على هذا الرابط لتقوم بملء استمارتك:

    //           ${process.env.CLIENT_URL_PRODUCTION}/auth/account/activate/${token}
    //       `
    //       )
    //       .then(() => {
    //         return res.json({
    //           message: `لقد تم ارسال رسالة جديدة إلى رقمك علي: ${phone}`,
    //         });
    //       })
    //       .catch((err) => {
    //         console.log(err);
...
exports.forgotPassword = (req, res) => {
  ...
  User.findOne({ email }, (err, user) => {
    ...
    const emailData = {
      ...
      html: `
          <h4>لقد تلقيت هذا البريد من موقع ألاقي:</h4>
